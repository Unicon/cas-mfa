...
public final class MultiFactorAuthenticationRequestsCollectingArgumentExtractor implements ArgumentExtractor {
     ...
     * @return mfa request
     */
    private static MultiFactorAuthenticationRequestContext createMfaRequest(
            final MultiFactorAuthenticationSupportingWebApplicationService service, final int mfaMethodRank) {
