...
public class RegexAuthenticationMethodTranslatorTests {
    ...
    public void testTranslate() {
        ...
        regexAuthenticationMethodTranslator.setDefaultMfaMethod("test");
        assertEquals("test", regexAuthenticationMethodTranslator.translate(null, "CN=sudoers,OU=AdminGroups,DC=example,DC=edu"));
    }
    ...
    public void testTranslateException() {
        ...
        RegexAuthenticationMethodTranslator regexAuthenticationMethodTranslator = new RegexAuthenticationMethodTranslator(testMap);
        regexAuthenticationMethodTranslator.setIgnoreIfNoMatchIsFound(false);
